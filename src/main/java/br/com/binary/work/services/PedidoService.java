...
import br.com.binary.work.dao.ClienteDAO;
import br.com.binary.work.dao.ItensPedidoDAO;
import br.com.binary.work.dao.PedidoDAO;
import br.com.binary.work.dao.ProdutoDAO;
        ...
        try {
            if (validarPedido(pedido)) {
                ...
                for (ItensPedidoModel item : pedido.getItensPedido()) {
                    //recupera o id e set nos itens do pedido
