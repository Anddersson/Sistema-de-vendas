...
<body id=fundo>
	<div class="container">
		...
		<form action="Usuarios" method="post">
			<input type="hidden" value="${usuario.idUsuario}" id="idUsuario"
				name="idUsuario"> <input type="hidden" value="alterar"
				id="acao" name="acao">
			<div class="row">
				...
				<div class="form-group col-md-5">
					...
					<input type="text" class="form-control" id="nome" name="nome"
						maxlength="80" placeholder="Nome Completo" required
						value="${usuario.nome}">
				</div>
				...
				<div class="form-group col-md-3">
					...
					<input type="text" class="form-control" name="cpf" id="cpf"
						minlength="11" maxlength="11" readonly value="${usuario.cpf}">
				</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			var option = new Option('${usuario.cargo}', '${usuario.cargo}');
			$('#cargo').append($(option));
		...
		function obterCargos(setor) {
			$
					.ajax({
						...
						error : function() {
							toastr.error('Ocorreu um erro ao buscar os cargos',
									'Erro');
						}
					});
		}
