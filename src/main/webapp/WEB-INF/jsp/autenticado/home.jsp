...
<style>
body {
	background-image: img/url('LogoTadesGames2.png');
	background: #D3D3D3;
...
<body>
	...
	<div class="container">
		...
		<h3 class="text-center">
			<img src="../resources/img/LogoTadesGames.png" class="img-fluid"
		...
		<div class="row justify-content-around">
			<div class="card-deck ">
				...
				<div class="card border-warning mb-3" style="max-width: 20rem;">
					...
					<div class="card-body" id=fundo>
						<h4 class="card-title">
							Melhor vendedor do mês: <small><strong>${homeVendedor.nomeVendedor}</strong></small>
						</h4>
						<p class="card-text" id="totalVendido">Total vendidos: R$
							${homeVendedor.totalVendido}</p>
						<p class="card-text">Total de vendas:
							${homeVendedor.qtdvendas}</p>
					</div>
				</div>
			</div>
		</div>
