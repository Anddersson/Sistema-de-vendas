...
<body id=fundo>
	<div class="container">
		...
		<form action="Filiais" method="post">
			<input type="hidden" value="${filial.idFilial}" id="idFilial"
				name="idFilial"> <input type="hidden" value="alterar"
				id="acao" name="acao">
			...
			<div class="row">
				<div class="form-group col-md-5">
					...
					<input type="text" class="form-control" id="nomeFilial" name="nome"
						placeholder="Digite o nome da Filial" required
						value="${filial.nome}">
				</div>

				<div class="form-group col-md-3">
					<label for="cnpj">CNPJ <h11 class="text-danger">*</h11></label> <input
						type="text" class="form-control cnpj" id="CNPJFilial" name="cnpj"
						placeholder="Digite o CNPJ da Filial" readonly
						value="${filial.cnpj}">
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-3">
					<label for="cep">CEP<h11 class="text-danger">*</h11></label> <input
						type="text" class="form-control cep" id="cep" name="cep"
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" id="logradouro"
						...
						value="${filial.logradouro}" readonly>
				</div>

				<div class="form-group col-md-2">
					<label for="numero">Numero<h11 class="text-danger">*</h11></label>
					<input type="text" class="form-control number" id="numero"
						name="numero" placeholder="Digite o numero" required
						value="${filial.numero}">
				</div>
			...
			<div class="row">
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" id="bairro" name="bairro"
						placeholder="Digite o bairro" required value="${filial.bairro}"
						readonly>
				</div>
				...
				<div class="form-group col-md-4">
					...
					<input type="text" class="form-control" id="cidade" name="cidade"
						placeholder="Digite a cidade" required value="${filial.cidade}"
						readonly>
				</div>
				...
				<div class="form-group col-md-2">
					...
					<input type="text" class="form-control" id="uf" name="uf"
						placeholder="Digite estado" required value="${filial.estado}"
						readonly>
				</div>
				...
				function() {
					if ($("#cep").val() === '00000-000'
						...
						$.ajax({
							...
							url : 'https://viacep.com.br/ws/' + $(this).val()
									+ '/json/unicode/',
