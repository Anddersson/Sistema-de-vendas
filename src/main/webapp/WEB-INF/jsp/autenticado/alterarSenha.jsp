...
<body id=fundo>
	<div class=" container">
		...
		<h11>
		<small>Ao alterar a senha será efetuado o logout e você deverá
			logar novamente com a nova senha</small></h11>
		<hr>
		...
		<form action="alterar-senha" method="post" id="form">
			<input type="hidden" value="${sessionScope.usuarioLogado.idUsuario}"
				id="idUsuario" name="idUsuario"> <input type="hidden"
				value="alterarSenha" id="acao" name="acao">
			...
			<div class="">
				<div class="form-group col-md-5">
					...
					<input type="password" id="senhaAtual" name="senhaAtual" value=""
						class="form-control" placeholder="Senha Atual" required>
				</div>
				<div class="form-group col-md-5">
				...
				<div class="form-group col-md-5">
					<label for="confirmaSenha">Confirmar Senha<h11
							class="text-danger">*</h11></label> <input type="password"
						id="confirmaSenha" name="confirmaSenha" value=""
		...
		$('#form').submit(
				function(e) {
					if ($('#novaSenha').val() !== $('#confirmaSenha').val()) {
						toastr.warning(
								'As senhas não conferem, por favor verificar',
								'Atenção');
						e.preventDefault();
					} else {
						this.submit;
